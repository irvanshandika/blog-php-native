    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-gray-700 border-gray-700">
                ...
                <li>
                    <a href="dashboard.php" class="block py-2 pl-3 pr-4 rounded md:border-0 md:hover:text-blue-700 md:p-0 text-white hover:bg-gray-900 hover:text-white md:hover:bg-transparent">Dashboard</a>
                </li>
            </ul>
        </div>
    </div>
